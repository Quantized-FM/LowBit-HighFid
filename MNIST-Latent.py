...
SAVE_PLOT_DIR = "latent_variance_plots_mnist"
...
def get_loader_mnist(num_samples=10000):
    ...
    fullset = datasets.MNIST(root=DATA_ROOT, train=False, download=False, transform=transform)
...
write_log(f"All latent shrinkage stats saved to latent_shrinkage_summary_{DATASET.lower()}_mnist.csv")
