...
DATASET = "ImageNet"
DATA_ROOT = "/path/to/imagenet/data/train_blurred_64/box"
BASE_CKPT_PATH = "/path/to/saved/models/"
SAVE_PLOT_DIR = "latent_variance_plots_imagenet"
...
# --------- LOADER ---------
def get_loader_imagenet(num_samples=10000):
    data_root = "/home/gdlteam1/Downloads/train_blurred_64/box"  # Update as needed
    transform = transforms.Compose([transforms.ToTensor()])
    fullset = datasets.ImageFolder(root=data_root, transform=transform)
    indices = list(range(min(num_samples, len(fullset))))  # Use first N samples
...
test_images = get_loader_imagenet()
